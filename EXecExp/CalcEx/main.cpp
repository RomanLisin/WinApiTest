...
VOID SetFont(HWND hwnd, LPSTR fontName);            //----

INT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    static CONST CHAR DEFAULT_SKIN[] = "square_blue";   //----
    static CONST CHAR DEFAULT_FONT[] = "digital-7";     //---- //----
    static CHAR skin[MAX_PATH]{};                       //---- change on 65 
    static CHAR font[MAX_PATH]{};                       //---- change on 65  //-----
    ...
    case WM_CREATE:
    {
        ...
        SetFont(hwnd, (LPSTR)DEFAULT_FONT);                ///---------  //------
    }
    break;
    case WM_COMMAND:
    {
    ...
    case WM_CONTEXTMENU:                      //-----
    {
        ...
        InsertMenu(hFontMenu, 0, MF_BYPOSITION | MF_STRING, CM_FONT_DIGITAL, "Digital-7");          //----- //-----
        ...
        case CM_METAL_MISTRAL: SetSkin(hwnd, (LPSTR)"metal_mistral"); color_scheme = MERCURY; break;
        case CM_FONT_DIGITAL: SetFont(hwnd, (LPSTR)"digital-7"); break;               //----- //----
        case CM_FONT_ARIAL: SetFont(hwnd, (LPSTR)"Arial"); break;                     //-----   //-----
...
VOID SetSkin(HWND hwnd, LPSTR skin)
{
    ...
    for (int i = IDC_BUTTON_0; i <= IDC_BUTTON_EQUAL; i++)
    {
        ...
        (
            ...
            sz_file,
            IMAGE_BITMAP,
            width,//i == IDC_BUTTON_0 ? g_i_BUTTON_DOUBLE_SIZE : g_i_BUTTON_SIZE,
            height,//i == IDC_BUTTON_EQUAL ? g_i_BUTTON_DOUBLE_SIZE : g_i_BUTTON_SIZE,
            LR_LOADFROMFILE
        );
