...
INT CALLBACK WndProc(HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
    ...
    case WM_CREATE:
    {
        ...
        SetFont(hwnd, (LPSTR)"light_led_display - 7");
    ...
    case WM_CONTEXTMENU:
    {
        ...
        InsertMenu(hSubMenu, 0, MF_BYPOSITION | MF_STRING, CM_SQUARE_YELLOW, "New model");
        ...
        //HMENU hFontMenu = CreatePopupMenu();
        InsertMenu(hFontMenu, 0, MF_BYPOSITION | MF_STRING, CM_FONT_DIGITGRAPH, "Digit graph");
        ...
        {
            SetSkin(hwnd, (LPSTR)"metal_mistral");
            color = GREY;
        }
            break;
        case CM_FONT_LIGHTLED: 
            SetFont(hwnd, (LPSTR)"light-led-display-7"); 
            break;
        case CM_FONT_DIGITGRAPH: 
            SetFont(hwnd, (LPSTR)"01-digitgraphics"); 
            break;
        case CM_EXIT: 
            DestroyWindow(hwnd); 
            break;
